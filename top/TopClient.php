...
include_once './vendor/smssdk/top/ResultSet.php';
include_once './vendor/smssdk/top/RequestCheckUtil.php';
include_once './vendor/smssdk/top/TopLogger.php';
include_once './vendor/smssdk/TopSdk.php';
class TopClient
{
	public $appkey;
